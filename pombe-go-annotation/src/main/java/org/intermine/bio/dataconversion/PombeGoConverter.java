 ...
 * @author Daniela Butano - refactored model -> given a go annotation there migh
 * be more than one annotation extension related to the evidence code and to
 * a single publication
 */
public class PombeGoConverter extends BioFileConverter
{
    protected static final String PROP_FILE = "pombe-go-annotation_config.properties";
    ...
    private static final Logger LOG = Logger.getLogger(PombeGoConverter.class);
     ...
     */
    public PombeGoConverter(ItemWriter writer, Model model) throws Exception {
        super(writer, model);
    ...
    private class Evidence
    {
        ...
        protected Evidence(String evidenceCode, String publicationRefId,
